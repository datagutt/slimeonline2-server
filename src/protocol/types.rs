...
impl MessageType {
    ...
    pub fn from_id(id: u16) -> Self {
        match id {
            ...
            33 => Self::CollectibleTaken,
            34 => Self::CollectibleTakeSelf,
            35 => Self::OneTimeInfo,
            ...
            50 => Self::PlayerSetStatus,
            51 => Self::ReturnItem,
            52 => Self::SignTxtRequest,
            53 => Self::PointsDec,
            54 => Self::SellReqPrices,
            55 => Self::Sell,
            56 => Self::StorageReq,
            ...
            119 => Self::RaceInfo,
            120 => Self::RaceStart,
            121 => Self::RaceCheckpoint,
            122 => Self::RaceEnd,
            123 => Self::MoveGetOn,
            124 => Self::MoveGetOff,
            125 => Self::ServerTimeReset,
            126 => Self::ClanCreate,
            ...
            134 => Self::BbsRequestMessages,
            135 => Self::BbsReportMessage,
            136 => Self::BbsRequestPost,
            137 => Self::BbsPost,
            138 => Self::BbsRequestCategories,
            139 => Self::BbsRequestGui,
            140 => Self::BbsRequestMaxPages,
            141 => Self::BbsRequestMessageContent,
    ...
    pub fn id(&self) -> u16 {
        match self {
            ...
            Self::CollectibleTaken => 33,
            Self::CollectibleTakeSelf => 34,
            Self::OneTimeInfo => 35,
            ...
            Self::PlayerSetStatus => 50,
            Self::ReturnItem => 51,
            Self::SignTxtRequest => 52,
            Self::PointsDec => 53,
            Self::SellReqPrices => 54,
            Self::Sell => 55,
            Self::StorageReq => 56,
            ...
            Self::RaceInfo => 119,
            Self::RaceStart => 120,
            Self::RaceCheckpoint => 121,
            Self::RaceEnd => 122,
            Self::MoveGetOn => 123,
            Self::MoveGetOff => 124,
            Self::ServerTimeReset => 125,
            Self::ClanCreate => 126,
            ...
            Self::BbsRequestMessages => 134,
            Self::BbsReportMessage => 135,
            Self::BbsRequestPost => 136,
            Self::BbsPost => 137,
            Self::BbsRequestCategories => 138,
            Self::BbsRequestGui => 139,
            Self::BbsRequestMaxPages => 140,
...
impl fmt::Display for MessageType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let name = match self {
            ...
            Self::PlayerSetStatus => "PlayerSetStatus",
